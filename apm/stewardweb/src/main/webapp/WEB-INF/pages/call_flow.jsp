...
function getSlowCallData(data){
    ...
    $.each(data, function(index, item){
        var code_item = {
            ...
            "rpc": item.application,
            "timeResponse": item.elapsed,
            "exception": item.exception,
            "agentId": item.agentId,
            "remoteAddr": item.remoteAddr,
            "transactionId": item.traceId
        }
...
$(document).ready(function(){
	...
	var json_url = '/stewardweb/transactionmetadata.do?agentID=' + agentID + '&from=' + sttime + '&to=' + endtime + '&limit=5000&v=2';
    ...
    $.getJSON(json_url,function(data,status){
    	//alert(data.metadata);
    	var data_slow_call = data.metadata;
...
function submitSearchForm(){
    ...
    var new_url = '/stewardweb/call_flow.do?agentID='+ agentID+'&sttime=' + sttime + '&endtime=' + endtime + '&limit=5000&v=2&threshold=' + threshold;
...
<div class="bodywrapper">
    ...
    <div class="header">
    	<ul class="headermenu">
			...
			<li class="current"><a onclick='navjump(6)'><span class="icon icon-callflow"></span>分布式调用流</a></li>
            
        </ul>
    </div><!--header-->
    
    <div class="pageheader">
    	<h1 class="pagetitle contenttitle2">分布式调用流</h1>
        <!--
