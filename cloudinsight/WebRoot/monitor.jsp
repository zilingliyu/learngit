...
<script src="js/bootstrap.min.js"></script>
    ...
    series: serise
       ...
       $('#main').contextMenu('myMenu1',{
   			...
   			'email': function(t){
   				window.open('http://124.127.117.26:8080/Monitor/login?userName=cloudinsight&&passWord=cloudinsight','_parent','height=100,width=400,top=0,left=0,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
   			},
   			'save': function(t){
   			...
   			'nfv': function(t){
   		    window.open ('http://180.153.47.167:8088/NFV','_parent','height=100,width=400,top=0,left=0,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
   			},
   			'delete': function(t){
