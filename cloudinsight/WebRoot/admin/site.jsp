...
<div class="content-section-b">
  <div class="container">
   <div class="row" style="background: #fff; margin-top: 10px;">
					...
					<div id="myTabContent" class="panel-group">
						<div id="service-one" class="panel panel-default">
							...
							<div class="panel-body" style="padding-bottom: 5px;">							
								...
								-->	
									<form action="${pageContext.request.contextPath}/admin/getSite.do" method="post">
											...
											<td style="text-decoration: none;">
											  <a href="javascript:edit_Mes();" style="margin-right: 20px;"><span class="glyphicon glyphicon-edit" title="编辑" style="color:black;"></span></a>
											   <a href="javascript:"style="margin-right: 20px;"><span class="glyphicon glyphicon-remove" title="删除" style="color:black;"></span></a>
												<a href="javascript:get_Map('${map.name}')" ><span class=" glyphicon glyphicon-list" title="图表" style="color:black;"></span></a> 
											</td>
										</tr>
									</tbody>
				...
				<!-- 图形 -->
				<br />
             <div class="row" style="display: none;" id="show_map">
             <div class="col-lg-12'">
              <div id="radarmain" class="col-md-12 col-sm-12" style="height:400px;width: 100%;">
             </div>
          ...
          <script src="js/jquery.js"></script>
			...
			<script src="js/page_sites.js"></script>
