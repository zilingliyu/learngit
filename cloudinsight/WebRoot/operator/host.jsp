  ...
  <header id="myCarousel" class="carousel slide" data-interval="false" data-ride="carousel" ">
      ...
      <div class="carousel-inner">
        <div class="item active">
          <div class="fill" style="background-image: url('img/services.jpg');"></div>
          <div class="carousel-caption">
            <h1 class="text-center">移动互联网蓬勃发展，云计算驱动产业升级</h1>
            <h2>这是一个体验为王、极致精简的时代</h2>
          </div>
        </div>
      </div>
    </header>
					...
					<div class="panel-group">
						<div class="panel panel-default">
							...
							<div class="panel-body" style="padding-bottom: 5px;">
									...
									<form action="${pageContext.request.contextPath}/operator/gethost.do" method="post">
							...
							<table id="monitor" class="table table-bordered table-hover" style="font-size: 10px;">
								...
								<c:forEach var="map" items="${list}" varStatus="status">
									...
									<tbody>
										<tr>
											<td>
												<input type="checkbox" id="check" value='${map.hostid}'>
											</td>
											
											<td>
												${map.proxy}:<span>${map.name}</span>
											</td>
											...
											<td>
												<a href="${pageContext.request.contextPath}/operator/getTrig.do?hostid=${map.hostid}">告警</a>
											</td>
											<td>
												正常
											</td>
				 ...
				 <h4 class="media-heading">
				     ...
				     <div class="media-body">
				         <div class="form-group">
				            ...
				            <option class="-1">请选择监控项</option>
				            
				            </select>
				             <br/><br/>
				             <button class="btn-block pull-right btn btn-primary" id="query_chart" loading-text="请稍后...">查询</button>
				         </div>
